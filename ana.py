...
class ana1(QMainWindow):
    ...
    def __init__(self):
        ...
        pixmap = QPixmap('gorseller\\bayrak.png')
        ...
        label1 = QLabel(self)
        label1.setFixedSize(192, 64)
        pixmap1 = QPixmap('gorseller\\teknokent.png')
        pixmap1 = pixmap1.scaledToWidth(192)
        pixmap1 = pixmap1.scaledToHeight(64)
    ...
    def veri1(self):
       os.startfile(r'veri_kayit\\anaveri.csv')
    def grafikg1(self):
        os.startfile(r"anagrafikler")
    def time(self):
        ...
        try:
            if xbee.inWaiting() > 0:
                ...
                if len(basincmat1) > 60:  # GRafik kayıt için
                    ...
                    exporter.export('anagrafikler\g_basinc\g_basinc' + str(self.counter_) + '.png')
                ...
                if len(yukseklikmat1) > 60:  # GRafik kayıt için
                    ...
                    exporter.params.param('width').setValue(965, blockSignal=exporter.widthChanged)
                    exporter.params.param('height').setValue(608, blockSignal=exporter.heightChanged)
                    exporter.export('anagrafikler\g_yukseklik\g_yukseklik' + str(self.counter_1) + '.png')
                ...
                if len(hizmat1) > 60:  # GRafik kayıt için
                    ...
                    exporter.params.param('width').setValue(965, blockSignal=exporter.widthChanged)
                    exporter.params.param('height').setValue(608, blockSignal=exporter.heightChanged)
                    exporter.export('anagrafikler\g_hiz\g_hiz' + str(self.counter_2) + '.png')
                    hizmat1 = [float(hiz1)]
                if len(sicaklikmat1) > 60:  # GRafik kayıt için
                    ...
                    exporter.params.param('width').setValue(965, blockSignal=exporter.widthChanged)
                    exporter.params.param('height').setValue(608, blockSignal=exporter.heightChanged)
                    exporter.export('anagrafikler\g_sicaklik\g_sicaklik' + str(self.counter_3) + '.png')
                ...
                if len(pilgermat1) > 60:  # GRafik kayıt için
                    ...
                    exporter.params.param('width').setValue(965, blockSignal=exporter.widthChanged)
                    exporter.params.param('height').setValue(608, blockSignal=exporter.heightChanged)
                    exporter.export('anagrafikler\g_pilger\g_pilger' + str(self.counter_4) + '.png')
                    pilgermat1 = [float(pilger1)]
                with open(r'veri_kayit\\anaveri.csv', 'a') as outfile:
